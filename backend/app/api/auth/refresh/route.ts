...
// Refresh tokens do Supabase são opacos e o tamanho pode variar entre versões.
// A validade é decidida pelo próprio Supabase, não por uma suposição local de tamanho.
